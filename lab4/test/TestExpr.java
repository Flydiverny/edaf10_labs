...
public class TestExpr {
	...
	public void kebabTest() {
		...
		Expr expr = new Implies(new Not(p), new Or(new And(q, p), a));
	...
	public void tautologyTest() {
		...
		Expr expr = new Implies(new Implies(new Not(p), new Not(q)), new Implies(new Implies(new Not(p), q), p));
